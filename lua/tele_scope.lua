...
map('n', '<C-S-f>', [[<cmd>Telescope live_grep theme=get_dropdown<cr>]], silent)

map('n', '<C-f>', [[<cmd>lua require('telescope.builtin').live_grep({search_dirs={vim.fn.expand("%:p")}})<CR>]], silent)
